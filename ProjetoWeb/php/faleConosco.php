...
<body>
    <header>
        ...
        <nav>
            <ul class="menu">
                <li><a href="../html/index.html" class="inicio" target="_self"><img src="../img/inicio.png" alt="Inicio"></a></li>
                <li><a href="http://ccnt.uepa.br/" target="_blank" rel="external">CCNT UEPA</a></li>
                <li><a href="../html/curso.html" target="_self" rel="next">Estrutura do curso</a></li>
                <li><a href="../html/avaliacao.html" target="_self" rel="next">Avaliação</a></li>
                <li><a href="../html/corpo_docente.html" target="_self" rel="next">Corpo docente</a></li>
                <li><a href="../html/infraestrutura.html" target="_self" rel="next">Estrutura do campus</a></li>
                <li><a href="../html/colegiado.html" target="_self" rel="next">Colegiado</a></li>
                <li><a href="../html/nucleo_docente.html" target="_self" rel="next">Núcleo docente</a></li>
    ...
    <section class="apresentacao">
        <div class="container">
            ...
            <form action="cad_pergunta.php" method="POST">
                <div class="row">
    ...
    <footer>
        ...
        <div class="container">
            ...
            <div class="copy">
                <p>&copy; Copyright 2023 | Diogo de Souza Corrêa | Léo Queiroz Pontes</p>
            </div>
